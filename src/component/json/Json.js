...
export const detailPageJson = [{
    ...
    Needtoknow: "<ul><li>To be eligible for refund/changes certain criteria on our tour need to be followed. </li><li>●	In case of unforeseen circumstances, and a refund is required, it must be documented to the booking manager through a booking channel like WhatsApp, email, or direct messaging.</li><li>	At least 24 hours before tour departure, in which case there will be a 100% refund being offered. But 24-12 hours, before departure, there will be a 50% refund and there will be no refund if the cancellation happens in less than 12 hours. </li><li>●	Tour departure is indicated in the booking confirmation. </li><li>It is important to consider that weather conditions do not influence term number 2. </li></ul>",
